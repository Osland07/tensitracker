...
<div class="mb-6">
    ...
    <p class="text-sm text-gray-500">Kelola data tingkat risiko aplikasi.</p>
</div>
...
<div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
    ...
    <div class="flex gap-2 w-full md:w-auto">
        <a href="/admin/risk-levels/new" class="inline-grid grid-flow-col auto-cols-max items-center justify-center gap-2 px-4 py-2 bg-brand-blue text-white text-sm font-medium rounded-lg hover:bg-blue-900 transition shadow-sm">
            <i data-lucide="plus" class="w-4 h-4"></i>
            <span>Tambah Data</span>
        </a>
        <a href="/admin/risk-levels/print" target="_blank" class="flex items-center justify-center px-4 py-2 bg-white border border-gray-300 text-[#001B48] text-sm font-medium rounded-lg hover:bg-orange-50 hover:border-orange-200 transition shadow-sm">
    ...
    <table class="min-w-full divide-y divide-gray-200">
            ...
            <?php else: ?>
                ...
                <tr class="hover:bg-gray-50">
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-brand-orange">
                        <?= esc($item['code']) ?>
                    </td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div class="flex justify-end gap-2">
                            <a href="/admin/risk-levels/edit/<?= $item['id'] ?>" class="flex items-center justify-center px-3 py-1.5 bg-orange-50 text-[#E3943B] border border-orange-200 rounded-md hover:bg-orange-100 transition">
                                <i data-lucide="pencil" class="w-3.5 h-3.5 mr-1.5"></i>
                                <span>Edit</span>
                            </a>
                            <a href="/admin/risk-levels/delete/<?= $item['id'] ?>" onclick="return confirm('Yakin ingin menghapus?')" class="flex items-center justify-center px-3 py-1.5 bg-red-50 text-red-600 border border-red-200 rounded-md hover:bg-red-100 transition">
